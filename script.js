document.addEventListener('DOMContentLoaded', () => {
    ...
    const responses = {
        ...
        "fee structure":"The fee structure varies depending on the class and other factors. For detailed information, you should refer to the school’s fee brochure or contact the school’s finance office.",
        ...
        "who made you":"i am made by Shaikh Haareess",
           ...
           "what extracurricular activities are offered":"Music, Arts, sports games, Debate etc.",
            "how does the school support students with special Needs":"By taking extra classes and helping the students",
             ...
             "what is the schools homework Policy": "Teachers Provide support and guidance for homework completion",
              get "what is the schools homework Policy"() {
                  return this["_what is the schools homework Policy"];
              },
              set "what is the schools homework Policy"(value) {
                  this["_what is the schools homework Policy"] = value;
              },
